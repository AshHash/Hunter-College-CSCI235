...
private:
    ...
    Node<T>* getMinimum(Node<T>* starting_ptr) const;
    //helper function that gets node ptr prior to the minimum node
    Node<T>* getPrevMinimum(Node<T>* starting_ptr) const;
